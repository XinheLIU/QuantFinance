...
\begin{itemize}
	\item Size
		...
		\subitem No longer significant as value
		\subitem Structural Bias - Less information from smaller business 
		\subitem Risk Sharing - Investor's Reluctance to invest in smaller firms
	\item Value
		\subitem High-Minus-Low 
		\subitem Behavior Bias - Rebalancing Contrarian Timing Reversals
		\begin{itemize}
		...
		\end{itemize}
		\subitem Who is on the other side
		\begin{itemize}
		...
		\end{itemize}
		\subitem in Equity and FX 
	\item Momentum 
		\subitem Behavior Bias 
			\begin{itemize}
	...
	\item Others
		...
		\subitem Seasonality: Benefiting from the market's ability to correctly estimate the seasonality of commodities (behavioral) and assume seasonality risk
		\subitem: COT : benefiting from the market's inability to process positioning data (behavioral） and the average investor's constraints in positioning according to such data
		\subitem Equity Intraday Momentum
\end{itemize}
